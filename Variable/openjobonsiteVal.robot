...
${Sleep}       3s
${Browser}        gc
${V_ServiceOrderType_OnsiteHD}       6




${V_ServiceOrderType_MailIn}       2
${V_ServiceOrderType_Pickup}       4
${V_ServiceType}            1
${V_Serial}       355183080075265    # mobile    lava    หน้า 18
${V_Serial2}      355183080082204
${V_Serial3}      355183080092849
